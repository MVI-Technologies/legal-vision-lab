export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-foreground text-background pl-5 pr-3 py-3 shadow-2xl hover:bg-accent transition-colors duration-300"
    >
      <span className="text-[11px] font-medium uppercase tracking-widest">Agendar Consulta</span>
      <span className="w-8 h-8 bg-[var(--whatsapp)] flex items-center justify-center" aria-hidden>
