...
export const Route = createFileRoute("/sobre")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sobre o Escritório | Martins S.A." },
      { name: "twitter:description", content: "Direito Criminal boutique. Defesa em profundidade, não em escala." },
