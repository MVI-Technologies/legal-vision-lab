...
export const Route = createFileRoute("/resultados")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Resultados e Diferenciais | Martins S.A." },
      { name: "twitter:description", content: "Resultados em defesa criminal estratégica para clientes corporativos." },
