...
export const Route = createFileRoute("/artigos")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Artigos e Notas Técnicas | Martins S.A." },
      { name: "twitter:description", content: "Conteúdo técnico de Direito Criminal pelo escritório Martins S.A." },
